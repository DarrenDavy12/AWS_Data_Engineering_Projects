...
This allows me to attach data to 'Glue database' to generate table schema based off the data and finally ready to be uploaded to 'athena' for querying later on in the later steps. 
